...
class Warnings(models.Model):
    ...
    ColaboradorID = models.ForeignKey(Colaborador, on_delete=models.CASCADE) #Relacionamento com o colaborador que recebeu a advertência
    ...
    def __str__(self):
        return f"{self.AdvertenciaID} - {self.ColaboradorID} - {self.CurrentStage}"
