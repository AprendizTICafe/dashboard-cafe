...
ROOT_URLCONF = 'projeto_cafe.urls'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'login.pipeline.save_department',
)

WSGI_APPLICATION = 'projeto_cafe.wsgi.application'
...
# Media files (User uploads - Anexos, Documentos, etc)
MEDIA_URL = '/media/'
...
# ===== Z-API Configuration (WhatsApp Notifications) =====
# Obtenha as credenciais em https://www.z-api.io
# IMPORTANTE: Adicione estas variáveis ao seu arquivo .env
ZAPI_INSTANCE_ID = os.getenv("ZAPI_INSTANCE_ID", "")
ZAPI_CLIENT_TOKEN = os.getenv("ZAPI_CLIENT_TOKEN", "")
